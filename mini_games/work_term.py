...
while run:
    ...
    prompt_text = font.render('Are you promotable?', True, (255, 255, 255))
...
promotable = True
a = int(input('chem 1050 grade:'))
b = int(input('phys 1051 grade:'))
c = int(input('math 1001 grade:'))
d = int(input('math 2050 grade:'))
e = int(input('engl 1090 grade:'))
f = int(input('engi 1010 grade:'))
g = int(input('engi 1020 grade:'))
h = int(input('engi 1030 grade:'))
i = int(input('engi 1040 grade:'))

average = (a + b + c + d + e + f + g + h + i) / 9
